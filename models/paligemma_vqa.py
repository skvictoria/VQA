...
class PaliGemma_VQA(BaseModel):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "paligemma-3b-ft-vqav2-448": "configs/models/paligemma_vqa/paligemma_ft_vqav2.yaml",
        "paligemma-3b-ft-vqav2-224": "configs/models/paligemma_vqa/paligemma_ft_vqav2_224.yaml",
